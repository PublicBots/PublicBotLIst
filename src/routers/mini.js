...
console.log("[publicbots.eu]: Mini pages router loaded.");
...
app.get("/robots.txt", function(req, res) {
    ...
    res.send(`Sitemap: https://publicbots.eu/sitemap.xml`);
});

app.get("/sitemap.xml", async function(req, res) {
    let link = "<url><loc>https://publicbots.eu/</loc></url>";
    let botdataforxml = await botsdata.find()
    botdataforxml.forEach(bot => {
        link += "\n<url><loc>https://publicbots.eu/bot/" + bot.botID + "</loc></url>";
    })
