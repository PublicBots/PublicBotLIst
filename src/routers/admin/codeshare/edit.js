...
console.log("[publicbots.eu]: Admin/CodeShare/Edit router loaded.");
...
app.post("/admin/editcode/:code", global.checkAuth, async (req, res) => {
    ...
    client.channels.cache.get(channels.codelog).send(new Discord.MessageEmbed()
        ...
        .setDescription(`The user named **[${req.user.username}](https://publicbots.eu/user/${req.user.id})** edited the code named **${rBody['codename']}**.`)
