...
exports.run = async (client, message, args) => {
	...
	if(!findServer) return message.channel.send(
		"This server was not found in our list.\nAdd your server: https://bot-list.publicbots.eu/server/add"
	);
  	if (findUser) {
    ...
    .setStyle("url")
    .setURL("https://bot-list.publicbots.eu/server/"+message.guild.id)
...
function msgError(msg, { channel }) {
    ...
    .setFooter('bot-list.publicbots.eu/servers')
    .setDescription(msg)
    .setColor("RED")
    )
}