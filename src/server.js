  ...
  module.exports = async (client) => {
   ...
   app.get("/login", (req, res, next) => {
    ...
    app.get("/callback", passport.authenticate("discord", { failureRedirect: "/error?code=999&message=We encountered an error while connecting." }), async (req, res) => {
        ...
        client.channels.cache.get(channels.login).send(new Discord.MessageEmbed().setAuthor(a.username, a.avatarURL({dynamic: true})).setThumbnail(a.avatarURL({dynamic: true})).setColor("RED").setDescription(`[**${a.username}**#${a.discriminator}](https://publicbots.eu/user/${a.id}) isimli kullanıcı **siteye** giriş yapmaya çalıştı fakat siteden engellendiği için giriş yapamadı.`).addField("Username", a.username).addField("User ID", a.id).addField("User Discriminator", a.discriminator))
        })
        req.session.destroy(() => {
    ...
    */
    ...
    sleep(1050)
    console.clear();
    console.log('\x1b[36m%s\x1b[0m', "[publicbots.eu]: General routers loading...");
    ...
    /* Uptime System */
    console.log(" ")
    console.log('\x1b[36m%s\x1b[0m', "[publicbots.eu]: Uptime system routers loading...");
    ...
    /* Profile System */
    console.log(" ")
    console.log('\x1b[36m%s\x1b[0m', "[publicbots.eu]: Profile system routers loading...");
    ...
    /* Code Share System */
    console.log(" ")
    console.log('\x1b[36m%s\x1b[0m', "[publicbots.eu]: Code Share system routers loading...");
    ...
    /* Botlist System */
    console.log(" ")
    console.log('\x1b[36m%s\x1b[0m', "[publicbots.eu]: Botlist system routers loading...");
    ...
    /* Server List System */
    console.log(" ")
    console.log('\x1b[36m%s\x1b[0m', "[publicbots.eu]: Serverlist system routers loading...");
    ...
    console.log(" ")
    console.log('\x1b[36m%s\x1b[0m', "[publicbots.eu]: Admin Panel system routers loading...");
    ...
    /* Bot System */
    console.log(" ")
    console.log('\x1b[36m%s\x1b[0m', "[publicbots.eu]: Bot system loading...");
